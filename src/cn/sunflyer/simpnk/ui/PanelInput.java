...
public class PanelInput extends JPanel{
	...
	private JTextField gInput = null ;
	
	/**
	 * 构造一个带标签输入框对象，默认宽500，高45
	 * */
	public PanelInput(String szDataName,String szInitData,boolean isReadOnly){
		this(szDataName,szInitData,isReadOnly,500,45);
	}
	
	public PanelInput(String szDataName,String szInitData,boolean isReadOnly,int Width,int Height){
	...
	public String getText(){
		return this.gInput == null ? null : this.gInput.getText();
	}
